...
public class QAService {
    ...
    public QAService(RestTemplate restTemplate, ConsultRepository consultRepository) {
...
//            System.out.println("debug đâyyyyyyyyyyyyyyyyyy "+jsonResponse);
    ...
    public void consult(@NotBlank String question, @Email String userEmail) {
    ...
    public void answerConsult(Long consultId, @NotBlank String answer) {
